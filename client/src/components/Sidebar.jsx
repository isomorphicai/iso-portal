...
import { 
  ChevronLeft, ChevronRight, Camera, Loader2, X
} from 'lucide-react';
  ...
  return (
    <aside className={`h-full shrink-0 bg-iso-bgSecondary border-r border-iso-border flex flex-col z-10 select-none relative transition-all duration-300 ease-in-out ${
      ...
      <div className="px-3 py-2.5 border-b border-iso-border flex items-center justify-between bg-iso-bgSecondary/20 overflow-hidden h-[72px] shrink-0">
        <div className="flex items-center justify-center overflow-hidden min-w-0 flex-1">
          {isCollapsed ? (
            ...
            /* Expanded view: Big Logo Only (Prominently Sized in Middle) */
            <div className="flex items-center justify-center overflow-hidden min-w-0 flex-1 px-1">
              {logoBig ? (
                <img 
                  src={logoBig} 
                  alt={brandName} 
                  className="h-13 max-h-14 max-w-[190px] object-contain object-center shrink-0 select-none" 
                  onError={(e) => {
              ...
              <span 
                style={{ display: 'none' }} 
                className="text-lg font-bold tracking-tight font-serif text-iso-primary whitespace-nowrap truncate text-center"
              >
                {brandName}
              </span>
            </div>
      ...
      <div className="w-full h-px bg-iso-border shrink-0 shadow-2xs" />
      ...
      <div className="p-3 flex items-center justify-between text-[11px] text-iso-textMuted font-mono bg-iso-bgSecondary/30 overflow-hidden h-11 shrink-0">
